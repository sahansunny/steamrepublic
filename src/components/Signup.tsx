...
export default function Signup({ onSignupSuccess, onSwitchToLogin, onShowPrivacy }: SignupProps) {
  ...
  return (
    <div className="signup">
      <div className="logo">
        <img src="/Steamreublic.png" alt="Steam Republic logo" className="logo-image" width={96} height={96} />
      </div>
      ...
      <div className="signup-form" role="form" aria-label="Sign up form">
        ...
        <div className="form-group">
          <label htmlFor="su-name">
            Full Name{' '}
            <span style={{ color: 'var(--text-3)', fontWeight: 400, fontSize: '9.5px', letterSpacing: '1px' }}>
